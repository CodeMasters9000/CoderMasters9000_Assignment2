...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "config_psh_56") //This must match your packages
public class SpringMVCConfig_psh_56 extends WebMvcConfigurationSupport {
